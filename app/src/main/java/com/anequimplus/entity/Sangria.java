...
public class Sangria extends Entidade{
    ...
    public Sangria(JSONObject j) throws JSONException {
        this.id = j.getInt("ID");
    ...
    public Sangria(int id, String descricao, Date data, int caixa_id, int modalidade_id, Double valor, String UUID, int status) {
        this.id = id;
